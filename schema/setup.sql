...
CREATE TABLE IF NOT EXISTS PANTRY_PLUS.ITEM (
    ...
    UPC char(15),
    INDEX idx_item_name_normalized (NAME_NORMALIZED)
);
...
CREATE TABLE IF NOT EXISTS PANTRY_PLUS.ITEM_ALIAS (
...
CREATE TABLE IF NOT EXISTS PANTRY_PLUS.SCHEMA_MIGRATIONS (
